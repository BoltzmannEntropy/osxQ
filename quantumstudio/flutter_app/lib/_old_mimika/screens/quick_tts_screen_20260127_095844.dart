  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      setState(() {
        ...
        _modelsByProvider['ollama'] = ollamaModels.isNotEmpty
            ? ollamaModels
            : ['(no models found)'];
        _isLoading = false;
      ...
      child: Column(
        ...
        children: [
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  const Text(
                    'British Phonetic Transcription',
                    style: TextStyle(fontWeight: FontWeight.bold),
                  ),
                  const Spacer(),
                      ...
                      onChanged: (value) {
                        if (value != null) {
                          setState(() {
                            ...
                            final models =
                                _modelsByProvider[value] ?? ['default'];
                            _selectedModel = models.isNotEmpty
                                ? models.first
                                : 'default';
                          });
                        }
                    ...
                    child: DropdownButtonFormField<String>(
                      value:
                          (_modelsByProvider[_selectedProvider]?.contains(
                              ...
                              false)
                          ? _selectedModel
                          : (_modelsByProvider[_selectedProvider]?.isNotEmpty ??
                                false)
                      ...
                      items: (_modelsByProvider[_selectedProvider] ?? []).map((
                        m,
                      ) {
                        final displayName = m.length > 20
                            ? '${m.substring(0, 18)}...'
                            : m;
                        return DropdownMenuItem(
                          value: m,
          ...
          TextField(
            ...
            onChanged: (_) {
              if (_selectedIpaSample != null &&
                  _textController.text != _selectedIpaSample!['input_text']) {
                setState(() {
          ...
          Row(
            children: [
              ...
              FilledButton.tonalIcon(
                onPressed: _isGeneratingIpa || _textController.text.isEmpty
                    ? null
                    : _generateIpa,
                ...
                label: Text(
                  _isGeneratingIpa ? 'Generating...' : 'Generate IPA',
                ),
              ),
            ],
          ),
